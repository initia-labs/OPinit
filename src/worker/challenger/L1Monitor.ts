      ...
      for (const evt of events) {
        ...
        switch (attrMap['type_tag']) {
          case '0x1::op_bridge::TokenRegisteredEvent': {
            ...
            await transactionalEntityManager.getRepository(ChallengerCoinEntity).save(coin);
            break;
          }
          case '0x1::op_bridge::TokenBridgeInitiatedEvent': {
            ...
            await transactionalEntityManager.getRepository(DepositTxEntity).save(entity);
            break;
          }
        }
      }
