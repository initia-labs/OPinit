...
import { build, executor, challenger, outputSubmitter } from 'test/utils/helper';
...
class L2Initializer{
    ...
    constructor(public submissionInterval, public finalizedTime, public l2StartBlockHeight){}
