...
func (m *QueryExecutorRequest) Reset()         { *m = QueryExecutorRequest{} }
func (m *QueryExecutorRequest) String() string { return proto.CompactTextString(m) }
...
func (m *QueryExecutorRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryExecutorRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryExecutorRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryExecutorRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryExecutorRequest.Merge(m, src)
}
func (m *QueryExecutorRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryExecutorRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryExecutorRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryExecutorRequest proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*QueryExecutorRequest)(nil), "opinit.opchild.v1.QueryExecutorRequest")
...
var fileDescriptor_15cfbb5d02a763ec = []byte{
	...
	,
}
...
func (c *queryClient) ExecutorPubKey(ctx context.Context, in *QueryExecutorRequest, opts ...grpc.CallOption) (*crypto.PublicKey, error) {
	...
	err := c.cc.Invoke(ctx, "/opinit.opchild.v1.Query/ExecutorPubKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedQueryServer) ExecutorPubKey(ctx context.Context, req *QueryExecutorRequest) (*crypto.PublicKey, error) {
...
func _Query_ExecutorPubKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/opinit.opchild.v1.Query/ExecutorPubKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *QueryExecutorRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryExecutorRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryExecutorRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryExecutorRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryExecutorRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryExecutorRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryExecutorRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
