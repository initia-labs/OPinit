...
var (
	ErrNoop                            = errorsmod.Register(ModuleName, 2, "no-op")
	...
	ErrInvalidHistoricalInfo           = errorsmod.Register(ModuleName, 7, "invalid historical info")
	ErrEmptyValidatorPubKey            = errorsmod.Register(ModuleName, 8, "empty validator public key")
	ErrInvalidSigner                   = errorsmod.Register(ModuleName, 9, "expected `opchild` module account as only signer for system message")
