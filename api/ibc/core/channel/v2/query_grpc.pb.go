...
const (
	Query_NextSequenceSend_FullMethodName       = "/ibc.core.channel.v2.Query/NextSequenceSend"
	Query_PacketCommitment_FullMethodName       = "/ibc.core.channel.v2.Query/PacketCommitment"
	Query_PacketCommitments_FullMethodName      = "/ibc.core.channel.v2.Query/PacketCommitments"
	Query_PacketAcknowledgement_FullMethodName  = "/ibc.core.channel.v2.Query/PacketAcknowledgement"
	Query_PacketAcknowledgements_FullMethodName = "/ibc.core.channel.v2.Query/PacketAcknowledgements"
	Query_PacketReceipt_FullMethodName          = "/ibc.core.channel.v2.Query/PacketReceipt"
	Query_UnreceivedPackets_FullMethodName      = "/ibc.core.channel.v2.Query/UnreceivedPackets"
	Query_UnreceivedAcks_FullMethodName         = "/ibc.core.channel.v2.Query/UnreceivedAcks"
)
