...
const (
	Query_InterchainAccount_FullMethodName = "/ibc.applications.interchain_accounts.controller.v1.Query/InterchainAccount"
	Query_Params_FullMethodName            = "/ibc.applications.interchain_accounts.controller.v1.Query/Params"
)
