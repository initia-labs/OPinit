...
var (
	...
	fd_FastBridgeConfig_fee_amount      protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_FastBridgeConfig_fee_amount = md_FastBridgeConfig.Fields().ByName("fee_amount")
}
...
func (x *fastReflection_FastBridgeConfig) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.FeeAmount != "" {
		...
		if !f(fd_FastBridgeConfig_fee_amount, value) {
			return
		}
	}
}
...
func (x *fastReflection_FastBridgeConfig) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "opinit.ophost.v1.FastBridgeConfig.fee_amount":
		return x.FeeAmount != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_FastBridgeConfig) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "opinit.ophost.v1.FastBridgeConfig.fee_amount":
		panic(fmt.Errorf("field fee_amount of message opinit.ophost.v1.FastBridgeConfig is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.ophost.v1.FastBridgeConfig"))
		}
...
type FastBridgeConfig struct {
	...
	// Fee amount in uinit
	FeeAmount string `protobuf:"bytes,5,opt,name=fee_amount,json=feeAmount,proto3" json:"fee_amount,omitempty"`
}
...
func (x *FastBridgeConfig) GetFeeAmount() string {
	if x != nil {
		return x.FeeAmount
	}
	return ""
...
var file_opinit_ophost_v1_types_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x42, 0x09, 0xc8, 0xde, 0x1f, 0x01, 0xa8, 0xe7, 0xb0, 0x2a, 0x00, 0x52,
	...
	0x75, 0x74, 0x70, 0x75, 0x74, 0x22, 0x8c, 0x02, 0x0a, 0x10, 0x46, 0x61, 0x73, 0x74, 0x42, 0x72,
	...
	0x64, 0x6f, 0x77, 0x12, 0x4f, 0x0a, 0x0a, 0x66, 0x65, 0x65, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e,
	...
	0x2e, 0x49, 0x6e, 0x74, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x09, 0x66, 0x65, 0x65, 0x41, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x22, 0x61, 0x0a, 0x13, 0x46, 0x61, 0x73, 0x74, 0x42, 0x72, 0x69, 0x64,
	0x67, 0x65, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x32, 0x0a, 0x07, 0x61,
	...
	0x06, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x42, 0xc9, 0x01, 0xc8, 0xe1, 0x1e, 0x00, 0xa8, 0xe2,
