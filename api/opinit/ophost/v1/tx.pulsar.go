...
var (
	...
	fd_MsgUpdateChallenger_new_challenger protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_MsgUpdateChallenger_new_challenger = md_MsgUpdateChallenger.Fields().ByName("new_challenger")
}
...
func (x *fastReflection_MsgUpdateChallenger) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.NewChallenger != "" {
		value := protoreflect.ValueOfString(x.NewChallenger)
		if !f(fd_MsgUpdateChallenger_new_challenger, value) {
			return
		}
	}
}
...
func (x *fastReflection_MsgUpdateChallenger) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "opinit.ophost.v1.MsgUpdateChallenger.bridge_id":
		return x.BridgeId != uint64(0)
	case "opinit.ophost.v1.MsgUpdateChallenger.new_challenger":
		return x.NewChallenger != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_MsgUpdateChallenger) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "opinit.ophost.v1.MsgUpdateChallenger.bridge_id":
		x.BridgeId = value.Uint()
	case "opinit.ophost.v1.MsgUpdateChallenger.new_challenger":
		x.NewChallenger = value.Interface().(string)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.ophost.v1.MsgUpdateChallenger"))
		}
...
func (x *fastReflection_MsgUpdateChallenger) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "opinit.ophost.v1.MsgUpdateChallenger.new_challenger":
		panic(fmt.Errorf("field new_challenger of message opinit.ophost.v1.MsgUpdateChallenger is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.ophost.v1.MsgUpdateChallenger"))
		}
...
func (x *fastReflection_MsgUpdateChallenger) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if len(x.NewChallenger) > 0 {
			i -= len(x.NewChallenger)
			copy(dAtA[i:], x.NewChallenger)
			i = runtime.EncodeVarint(dAtA, i, uint64(len(x.NewChallenger)))
			i--
			dAtA[i] = 0x1a
		}
		if x.BridgeId != 0 {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 3:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field NewChallenger", wireType)
				}
				var stringLen uint64
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				x.NewChallenger = string(dAtA[iNdEx:postIndex])
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
type MsgUpdateChallenger struct {
	...
	Authority     string `protobuf:"bytes,1,opt,name=authority,proto3" json:"authority,omitempty"`
	BridgeId      uint64 `protobuf:"varint,2,opt,name=bridge_id,json=bridgeId,proto3" json:"bridge_id,omitempty"`
	NewChallenger string `protobuf:"bytes,3,opt,name=new_challenger,json=newChallenger,proto3" json:"new_challenger,omitempty"`
}
...
func (x *MsgUpdateChallenger) GetNewChallenger() string {
	if x != nil {
		return x.NewChallenger
	}
	return ""
...
var file_opinit_ophost_v1_tx_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x63, 0x65, 0x22, 0xec, 0x05, 0x0a, 0x1a, 0x4d, 0x73, 0x67, 0x46, 0x69, 0x6e, 0x61,
	...
	0x2a, 0x21, 0x6f, 0x70, 0x68, 0x6f, 0x73, 0x74, 0x2f, 0x4d, 0x73, 0x67, 0x46, 0x69, 0x6e, 0x61,
	0x6c, 0x69, 0x7a, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61,
	0x77, 0x61, 0x6c, 0x22, 0x24, 0x0a, 0x22, 0x4d, 0x73, 0x67, 0x46, 0x69, 0x6e, 0x61, 0x6c, 0x69,
	0x7a, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x57, 0x69, 0x74, 0x68, 0x64, 0x72, 0x61, 0x77, 0x61,
	0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x93, 0x02, 0x0a, 0x11, 0x4d, 0x73,
	0x67, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x65, 0x72, 0x12,
	...
	,
	...
	0x6b, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x9d, 0x02, 0x0a, 0x13, 0x4d, 0x73, 0x67, 0x55,
	...
	,
	...
	0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0b, 0x6f, 0x75,
	0x74, 0x70, 0x75, 0x74, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x12, 0x26, 0x0a, 0x0f, 0x6c, 0x32, 0x5f,
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x04, 0x52, 0x0d, 0x6c, 0x32, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x4e, 0x75, 0x6d, 0x62, 0x65,
	0x72, 0x22, 0xa8, 0x02, 0x0a, 0x12, 0x4d, 0x73, 0x67, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42,
	0x61, 0x74, 0x63, 0x68, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x4a, 0x0a, 0x09, 0x61, 0x75, 0x74, 0x68,
	...
	,
	...
	0x32, 0x8c, 0x08, 0x0a, 0x03, 0x4d, 0x73, 0x67, 0x12, 0x59, 0x0a, 0x0b, 0x52, 0x65, 0x63, 0x6f,
	...
	0x70, 0x69, 0x6e, 0x69, 0x74, 0x2e, 0x6f, 0x70, 0x68, 0x6f, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x2e,
	0x4d, 0x73, 0x67, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x42, 0x61, 0x74, 0x63, 0x68, 0x49, 0x6e,
	0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x5c, 0x0a, 0x0c, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x21, 0x2e, 0x6f, 0x70, 0x69,
	...
	0xc2, 0x01, 0xc8, 0xe1, 0x1e, 0x00, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x6f, 0x70, 0x69, 0x6e,
	0x69, 0x74, 0x2e, 0x6f, 0x70, 0x68, 0x6f, 0x73, 0x74, 0x2e, 0x76, 0x31, 0x42, 0x07, 0x54, 0x78,
...
var file_opinit_ophost_v1_tx_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_opinit_ophost_v1_tx_proto_goTypes = []interface{}{
	...
	(*MsgUpdateParams)(nil),                    // 18: opinit.ophost.v1.MsgUpdateParams
	(*MsgUpdateParamsResponse)(nil),            // 19: opinit.ophost.v1.MsgUpdateParamsResponse
	(*BridgeConfig)(nil),                       // 20: opinit.ophost.v1.BridgeConfig
	(*v1beta1.Coin)(nil),                       // 21: cosmos.base.v1beta1.Coin
	(*BatchInfo)(nil),                          // 22: opinit.ophost.v1.BatchInfo
	(*Params)(nil),                             // 23: opinit.ophost.v1.Params
}
var file_opinit_ophost_v1_tx_proto_depIdxs = []int32{
	20, // 0: opinit.ophost.v1.MsgCreateBridge.config:type_name -> opinit.ophost.v1.BridgeConfig
	21, // 1: opinit.ophost.v1.MsgInitiateTokenDeposit.amount:type_name -> cosmos.base.v1beta1.Coin
	21, // 2: opinit.ophost.v1.MsgFinalizeTokenWithdrawal.amount:type_name -> cosmos.base.v1beta1.Coin
	22, // 3: opinit.ophost.v1.MsgUpdateBatchInfo.new_batch_info:type_name -> opinit.ophost.v1.BatchInfo
	23, // 4: opinit.ophost.v1.MsgUpdateParams.params:type_name -> opinit.ophost.v1.Params
	...
	18, // 14: opinit.ophost.v1.Msg.UpdateParams:input_type -> opinit.ophost.v1.MsgUpdateParams
	1,  // 15: opinit.ophost.v1.Msg.RecordBatch:output_type -> opinit.ophost.v1.MsgRecordBatchResponse
	3,  // 16: opinit.ophost.v1.Msg.CreateBridge:output_type -> opinit.ophost.v1.MsgCreateBridgeResponse
	5,  // 17: opinit.ophost.v1.Msg.ProposeOutput:output_type -> opinit.ophost.v1.MsgProposeOutputResponse
	7,  // 18: opinit.ophost.v1.Msg.DeleteOutput:output_type -> opinit.ophost.v1.MsgDeleteOutputResponse
	9,  // 19: opinit.ophost.v1.Msg.InitiateTokenDeposit:output_type -> opinit.ophost.v1.MsgInitiateTokenDepositResponse
	11, // 20: opinit.ophost.v1.Msg.FinalizeTokenWithdrawal:output_type -> opinit.ophost.v1.MsgFinalizeTokenWithdrawalResponse
	13, // 21: opinit.ophost.v1.Msg.UpdateProposer:output_type -> opinit.ophost.v1.MsgUpdateProposerResponse
	15, // 22: opinit.ophost.v1.Msg.UpdateChallenger:output_type -> opinit.ophost.v1.MsgUpdateChallengerResponse
	17, // 23: opinit.ophost.v1.Msg.UpdateBatchInfo:output_type -> opinit.ophost.v1.MsgUpdateBatchInfoResponse
	19, // 24: opinit.ophost.v1.Msg.UpdateParams:output_type -> opinit.ophost.v1.MsgUpdateParamsResponse
