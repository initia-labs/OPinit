...
const (
	...
	Query_MigrationInfo_FullMethodName  = "/opinit.opchild.v1.Query/MigrationInfo"
)
...
func (UnimplementedQueryServer) BridgeInfo(context.Context, *QueryBridgeInfoRequest) (*QueryBridgeInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BridgeInfo not implemented")
}
...
func (UnimplementedQueryServer) NextL2Sequence(context.Context, *QueryNextL2SequenceRequest) (*QueryNextL2SequenceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method NextL2Sequence not implemented")
}
