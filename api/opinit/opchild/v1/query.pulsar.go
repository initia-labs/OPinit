...
var (
	md_QueryExecutorRequest protoreflect.MessageDescriptor
)

func init() {
	file_opinit_opchild_v1_query_proto_init()
	md_QueryExecutorRequest = File_opinit_opchild_v1_query_proto.Messages().ByName("QueryExecutorRequest")
}

var _ protoreflect.Message = (*fastReflection_QueryExecutorRequest)(nil)

type fastReflection_QueryExecutorRequest QueryExecutorRequest

func (x *QueryExecutorRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryExecutorRequest)(x)
}

func (x *QueryExecutorRequest) slowProtoReflect() protoreflect.Message {
...
var _fastReflection_QueryExecutorRequest_messageType fastReflection_QueryExecutorRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryExecutorRequest_messageType{}

type fastReflection_QueryExecutorRequest_messageType struct{}

func (x fastReflection_QueryExecutorRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryExecutorRequest)(nil)
}
func (x fastReflection_QueryExecutorRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryExecutorRequest)
}
func (x fastReflection_QueryExecutorRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryExecutorRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryExecutorRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryExecutorRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryExecutorRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryExecutorRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryExecutorRequest) New() protoreflect.Message {
	return new(fastReflection_QueryExecutorRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryExecutorRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryExecutorRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryExecutorRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryExecutorRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryExecutorRequest"))
		}
		panic(fmt.Errorf("message opinit.opchild.v1.QueryExecutorRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryExecutorRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryExecutorRequest"))
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryExecutorRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryExecutorRequest"))
		}
		panic(fmt.Errorf("message opinit.opchild.v1.QueryExecutorRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryExecutorRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryExecutorRequest"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryExecutorRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryExecutorRequest"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryExecutorRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryExecutorRequest"))
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryExecutorRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in opinit.opchild.v1.QueryExecutorRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryExecutorRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryExecutorRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryExecutorRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryExecutorRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryExecutorRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryExecutorRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryExecutorRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			default:
				iNdEx = preIndex
...
// QueryExecutor is request type for the Query/Executor's public key RPC method
type QueryExecutorRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *QueryExecutorRequest) Reset() {
	*x = QueryExecutorRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opinit_opchild_v1_query_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryExecutorRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryExecutorRequest) ProtoMessage() {}

// Deprecated: Use QueryExecutorRequest.ProtoReflect.Descriptor instead.
func (*QueryExecutorRequest) Descriptor() ([]byte, []int) {
...
var file_opinit_opchild_v1_query_proto_rawDesc = []byte{
	...
	0x6b, 0x65, 0x79, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x60, 0x0a, 0x16, 0x51, 0x75,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x47, 0x0a, 0x0a, 0x76, 0x61, 0x6c, 0x69,
	0x64, 0x61, 0x74, 0x6f, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6f,
	...
	,
	...
	0x72, 0x61, 0x6d, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6f, 0x70, 0x69,
	...
	0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x32, 0x99, 0x04, 0x0a, 0x05, 0x51, 0x75, 0x65,
	...
	0x64, 0x72, 0x7d, 0x12, 0x7f, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x25, 0x2e,
	...
	,
...
var file_opinit_opchild_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_opinit_opchild_v1_query_proto_goTypes = []interface{}{
	...
	(*QueryExecutorRequest)(nil),    // 4: opinit.opchild.v1.QueryExecutorRequest
	(*QueryParamsRequest)(nil),      // 5: opinit.opchild.v1.QueryParamsRequest
	(*QueryParamsResponse)(nil),     // 6: opinit.opchild.v1.QueryParamsResponse
	(*v1beta1.PageRequest)(nil),     // 7: cosmos.base.query.v1beta1.PageRequest
	(*Validator)(nil),               // 8: opinit.opchild.v1.Validator
	(*v1beta1.PageResponse)(nil),    // 9: cosmos.base.query.v1beta1.PageResponse
	(*Params)(nil),                  // 10: opinit.opchild.v1.Params
	(*crypto.PublicKey)(nil),        // 11: tendermint.crypto.PublicKey
}
var file_opinit_opchild_v1_query_proto_depIdxs = []int32{
	7,  // 0: opinit.opchild.v1.QueryValidatorsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	8,  // 1: opinit.opchild.v1.QueryValidatorsResponse.validators:type_name -> opinit.opchild.v1.Validator
	9,  // 2: opinit.opchild.v1.QueryValidatorsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	8,  // 3: opinit.opchild.v1.QueryValidatorResponse.validator:type_name -> opinit.opchild.v1.Validator
	10, // 4: opinit.opchild.v1.QueryParamsResponse.params:type_name -> opinit.opchild.v1.Params
	0,  // 5: opinit.opchild.v1.Query.Validators:input_type -> opinit.opchild.v1.QueryValidatorsRequest
	2,  // 6: opinit.opchild.v1.Query.Validator:input_type -> opinit.opchild.v1.QueryValidatorRequest
	5,  // 7: opinit.opchild.v1.Query.Params:input_type -> opinit.opchild.v1.QueryParamsRequest
	4,  // 8: opinit.opchild.v1.Query.ExecutorPubKey:input_type -> opinit.opchild.v1.QueryExecutorRequest
	1,  // 9: opinit.opchild.v1.Query.Validators:output_type -> opinit.opchild.v1.QueryValidatorsResponse
	3,  // 10: opinit.opchild.v1.Query.Validator:output_type -> opinit.opchild.v1.QueryValidatorResponse
	6,  // 11: opinit.opchild.v1.Query.Params:output_type -> opinit.opchild.v1.QueryParamsResponse
	11, // 12: opinit.opchild.v1.Query.ExecutorPubKey:output_type -> tendermint.crypto.PublicKey
...
func file_opinit_opchild_v1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_opinit_opchild_v1_query_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryExecutorRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
