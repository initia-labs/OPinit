...
var (
	md_QueryForceWithdrawalProofsRequest             protoreflect.MessageDescriptor
	fd_QueryForceWithdrawalProofsRequest_l2_sequence protoreflect.FieldDescriptor
)

func init() {
	file_opinit_opchild_v1_query_proto_init()
	md_QueryForceWithdrawalProofsRequest = File_opinit_opchild_v1_query_proto.Messages().ByName("QueryForceWithdrawalProofsRequest")
	fd_QueryForceWithdrawalProofsRequest_l2_sequence = md_QueryForceWithdrawalProofsRequest.Fields().ByName("l2_sequence")
}

var _ protoreflect.Message = (*fastReflection_QueryForceWithdrawalProofsRequest)(nil)

type fastReflection_QueryForceWithdrawalProofsRequest QueryForceWithdrawalProofsRequest

func (x *QueryForceWithdrawalProofsRequest) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryForceWithdrawalProofsRequest)(x)
}

func (x *QueryForceWithdrawalProofsRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_opinit_opchild_v1_query_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryForceWithdrawalProofsRequest_messageType fastReflection_QueryForceWithdrawalProofsRequest_messageType
var _ protoreflect.MessageType = fastReflection_QueryForceWithdrawalProofsRequest_messageType{}

type fastReflection_QueryForceWithdrawalProofsRequest_messageType struct{}

func (x fastReflection_QueryForceWithdrawalProofsRequest_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryForceWithdrawalProofsRequest)(nil)
}
func (x fastReflection_QueryForceWithdrawalProofsRequest_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryForceWithdrawalProofsRequest)
}
func (x fastReflection_QueryForceWithdrawalProofsRequest_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryForceWithdrawalProofsRequest
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryForceWithdrawalProofsRequest
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) Type() protoreflect.MessageType {
	return _fastReflection_QueryForceWithdrawalProofsRequest_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) New() protoreflect.Message {
	return new(fastReflection_QueryForceWithdrawalProofsRequest)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) Interface() protoreflect.ProtoMessage {
	return (*QueryForceWithdrawalProofsRequest)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.L2Sequence != uint64(0) {
		value := protoreflect.ValueOfUint64(x.L2Sequence)
		if !f(fd_QueryForceWithdrawalProofsRequest_l2_sequence, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsRequest.l2_sequence":
		return x.L2Sequence != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryForceWithdrawalProofsRequest"))
		}
		panic(fmt.Errorf("message opinit.opchild.v1.QueryForceWithdrawalProofsRequest does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsRequest.l2_sequence":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsRequest.l2_sequence":
		value := x.L2Sequence
		return protoreflect.ValueOfUint64(value)
	default:
		...
		panic(fmt.Errorf("message opinit.opchild.v1.QueryForceWithdrawalProofsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsRequest.l2_sequence":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsRequest.l2_sequence":
		panic(fmt.Errorf("field l2_sequence of message opinit.opchild.v1.QueryForceWithdrawalProofsRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryForceWithdrawalProofsRequest"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsRequest.l2_sequence":
		return protoreflect.ValueOfUint64(uint64(0))
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in opinit.opchild.v1.QueryForceWithdrawalProofsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryForceWithdrawalProofsRequest) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryForceWithdrawalProofsRequest)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryForceWithdrawalProofsRequest: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryForceWithdrawalProofsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
var (
	md_QueryForceWithdrawalProofsResponse                  protoreflect.MessageDescriptor
	fd_QueryForceWithdrawalProofsResponse_commitment_proof protoreflect.FieldDescriptor
	fd_QueryForceWithdrawalProofsResponse_app_hash         protoreflect.FieldDescriptor
	fd_QueryForceWithdrawalProofsResponse_app_hash_proof   protoreflect.FieldDescriptor
)

func init() {
	file_opinit_opchild_v1_query_proto_init()
	md_QueryForceWithdrawalProofsResponse = File_opinit_opchild_v1_query_proto.Messages().ByName("QueryForceWithdrawalProofsResponse")
	fd_QueryForceWithdrawalProofsResponse_commitment_proof = md_QueryForceWithdrawalProofsResponse.Fields().ByName("commitment_proof")
	fd_QueryForceWithdrawalProofsResponse_app_hash = md_QueryForceWithdrawalProofsResponse.Fields().ByName("app_hash")
	fd_QueryForceWithdrawalProofsResponse_app_hash_proof = md_QueryForceWithdrawalProofsResponse.Fields().ByName("app_hash_proof")
}

var _ protoreflect.Message = (*fastReflection_QueryForceWithdrawalProofsResponse)(nil)

type fastReflection_QueryForceWithdrawalProofsResponse QueryForceWithdrawalProofsResponse

func (x *QueryForceWithdrawalProofsResponse) ProtoReflect() protoreflect.Message {
	return (*fastReflection_QueryForceWithdrawalProofsResponse)(x)
}

func (x *QueryForceWithdrawalProofsResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_opinit_opchild_v1_query_proto_msgTypes[15]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_QueryForceWithdrawalProofsResponse_messageType fastReflection_QueryForceWithdrawalProofsResponse_messageType
var _ protoreflect.MessageType = fastReflection_QueryForceWithdrawalProofsResponse_messageType{}

type fastReflection_QueryForceWithdrawalProofsResponse_messageType struct{}

func (x fastReflection_QueryForceWithdrawalProofsResponse_messageType) Zero() protoreflect.Message {
	return (*fastReflection_QueryForceWithdrawalProofsResponse)(nil)
}
func (x fastReflection_QueryForceWithdrawalProofsResponse_messageType) New() protoreflect.Message {
	return new(fastReflection_QueryForceWithdrawalProofsResponse)
}
func (x fastReflection_QueryForceWithdrawalProofsResponse_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryForceWithdrawalProofsResponse
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) Descriptor() protoreflect.MessageDescriptor {
	return md_QueryForceWithdrawalProofsResponse
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) Type() protoreflect.MessageType {
	return _fastReflection_QueryForceWithdrawalProofsResponse_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) New() protoreflect.Message {
	return new(fastReflection_QueryForceWithdrawalProofsResponse)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) Interface() protoreflect.ProtoMessage {
	return (*QueryForceWithdrawalProofsResponse)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.CommitmentProof != nil {
		value := protoreflect.ValueOfMessage(x.CommitmentProof.ProtoReflect())
		if !f(fd_QueryForceWithdrawalProofsResponse_commitment_proof, value) {
			return
		}
	}
	if len(x.AppHash) != 0 {
		value := protoreflect.ValueOfBytes(x.AppHash)
		if !f(fd_QueryForceWithdrawalProofsResponse_app_hash, value) {
			return
		}
	}
	if x.AppHashProof != nil {
		value := protoreflect.ValueOfMessage(x.AppHashProof.ProtoReflect())
		if !f(fd_QueryForceWithdrawalProofsResponse_app_hash_proof, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsResponse.commitment_proof":
		return x.CommitmentProof != nil
	case "opinit.opchild.v1.QueryForceWithdrawalProofsResponse.app_hash":
		return len(x.AppHash) != 0
	case "opinit.opchild.v1.QueryForceWithdrawalProofsResponse.app_hash_proof":
		return x.AppHashProof != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryForceWithdrawalProofsResponse"))
		}
		panic(fmt.Errorf("message opinit.opchild.v1.QueryForceWithdrawalProofsResponse does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsResponse.commitment_proof":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsResponse.commitment_proof":
	...
	default:
		...
		panic(fmt.Errorf("message opinit.opchild.v1.QueryForceWithdrawalProofsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsResponse.commitment_proof":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsResponse.commitment_proof":
		if x.CommitmentProof == nil {
	...
	case "opinit.opchild.v1.QueryForceWithdrawalProofsResponse.app_hash":
		panic(fmt.Errorf("field app_hash of message opinit.opchild.v1.QueryForceWithdrawalProofsResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.QueryForceWithdrawalProofsResponse"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "opinit.opchild.v1.QueryForceWithdrawalProofsResponse.commitment_proof":
		m := new(v1.ProofOps)
		return protoreflect.ValueOfMessage(m.ProtoReflect())
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in opinit.opchild.v1.QueryForceWithdrawalProofsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_QueryForceWithdrawalProofsResponse) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*QueryForceWithdrawalProofsResponse)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryForceWithdrawalProofsResponse: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: QueryForceWithdrawalProofsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 3:
				if wireType != 2 {
...
func (x *QueryForceWithdrawalProofsRequest) Reset() {
	*x = QueryForceWithdrawalProofsRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opinit_opchild_v1_query_proto_msgTypes[14]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryForceWithdrawalProofsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryForceWithdrawalProofsRequest) ProtoMessage() {}

// Deprecated: Use QueryForceWithdrawalProofsRequest.ProtoReflect.Descriptor instead.
func (*QueryForceWithdrawalProofsRequest) Descriptor() ([]byte, []int) {
	return file_opinit_opchild_v1_query_proto_rawDescGZIP(), []int{14}
}

func (x *QueryForceWithdrawalProofsRequest) GetL2Sequence() uint64 {
	if x != nil {
		return x.L2Sequence
	}
	return 0
...
type QueryForceWithdrawalProofsResponse struct {
	...
	CommitmentProof *v1.ProofOps `protobuf:"bytes,3,opt,name=commitment_proof,json=commitmentProof,proto3" json:"commitment_proof,omitempty"`
	// app hash and proof
	AppHash      []byte    `protobuf:"bytes,4,opt,name=app_hash,json=appHash,proto3" json:"app_hash,omitempty"`
	AppHashProof *v1.Proof `protobuf:"bytes,5,opt,name=app_hash_proof,json=appHashProof,proto3" json:"app_hash_proof,omitempty"`
}

func (x *QueryForceWithdrawalProofsResponse) Reset() {
	*x = QueryForceWithdrawalProofsResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_opinit_opchild_v1_query_proto_msgTypes[15]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *QueryForceWithdrawalProofsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryForceWithdrawalProofsResponse) ProtoMessage() {}

// Deprecated: Use QueryForceWithdrawalProofsResponse.ProtoReflect.Descriptor instead.
func (*QueryForceWithdrawalProofsResponse) Descriptor() ([]byte, []int) {
	return file_opinit_opchild_v1_query_proto_rawDescGZIP(), []int{15}
}

func (x *QueryForceWithdrawalProofsResponse) GetCommitmentProof() *v1.ProofOps {
	if x != nil {
...
func (x *QueryForceWithdrawalProofsResponse) GetAppHash() []byte {
	if x != nil {
		return x.AppHash
	}
	return nil
...
func (x *QueryForceWithdrawalProofsResponse) GetAppHashProof() *v1.Proof {
	if x != nil {
...
var file_opinit_opchild_v1_query_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x79, 0x70, 0x74, 0x6f, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x72, 0x6f, 0x6f, 0x66, 0x2e,
	...
	,
	...
	,
	...
	,
	...
	0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x26, 0x2e, 0x6f, 0x70, 0x69, 0x6e, 0x69,
	...
	0x31, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0xa1, 0x01, 0x0a, 0x0e, 0x4e, 0x65, 0x78,
	0x74, 0x4c, 0x31, 0x53, 0x65, 0x71, 0x75, 0x65, 0x6e, 0x63, 0x65, 0x12, 0x2d, 0x2e, 0x6f, 0x70,
	...
	0x6e, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2e, 0x2e, 0x6f, 0x70, 0x69,
	...
	,
	...
	,
}
...
var file_opinit_opchild_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_opinit_opchild_v1_query_proto_goTypes = []interface{}{
	...
	(*QueryForceWithdrawalProofsRequest)(nil),  // 14: opinit.opchild.v1.QueryForceWithdrawalProofsRequest
	(*QueryForceWithdrawalProofsResponse)(nil), // 15: opinit.opchild.v1.QueryForceWithdrawalProofsResponse
	(*v1beta1.PageRequest)(nil),                // 16: cosmos.base.query.v1beta1.PageRequest
	(*Validator)(nil),                          // 17: opinit.opchild.v1.Validator
	(*v1beta1.PageResponse)(nil),               // 18: cosmos.base.query.v1beta1.PageResponse
	(*BridgeInfo)(nil),                         // 19: opinit.opchild.v1.BridgeInfo
	(*Params)(nil),                             // 20: opinit.opchild.v1.Params
	(*v1.ProofOps)(nil),                        // 21: cometbft.crypto.v1.ProofOps
	(*v1.Proof)(nil),                           // 22: cometbft.crypto.v1.Proof
}
var file_opinit_opchild_v1_query_proto_depIdxs = []int32{
	16, // 0: opinit.opchild.v1.QueryValidatorsRequest.pagination:type_name -> cosmos.base.query.v1beta1.PageRequest
	17, // 1: opinit.opchild.v1.QueryValidatorsResponse.validators:type_name -> opinit.opchild.v1.Validator
	18, // 2: opinit.opchild.v1.QueryValidatorsResponse.pagination:type_name -> cosmos.base.query.v1beta1.PageResponse
	17, // 3: opinit.opchild.v1.QueryValidatorResponse.validator:type_name -> opinit.opchild.v1.Validator
	19, // 4: opinit.opchild.v1.QueryBridgeInfoResponse.bridge_info:type_name -> opinit.opchild.v1.BridgeInfo
	20, // 5: opinit.opchild.v1.QueryParamsResponse.params:type_name -> opinit.opchild.v1.Params
	21, // 6: opinit.opchild.v1.QueryForceWithdrawalProofsResponse.commitment_proof:type_name -> cometbft.crypto.v1.ProofOps
	22, // 7: opinit.opchild.v1.QueryForceWithdrawalProofsResponse.app_hash_proof:type_name -> cometbft.crypto.v1.Proof
	0,  // 8: opinit.opchild.v1.Query.Validators:input_type -> opinit.opchild.v1.QueryValidatorsRequest
	2,  // 9: opinit.opchild.v1.Query.Validator:input_type -> opinit.opchild.v1.QueryValidatorRequest
	4,  // 10: opinit.opchild.v1.Query.BridgeInfo:input_type -> opinit.opchild.v1.QueryBridgeInfoRequest
	6,  // 11: opinit.opchild.v1.Query.Params:input_type -> opinit.opchild.v1.QueryParamsRequest
	8,  // 12: opinit.opchild.v1.Query.NextL1Sequence:input_type -> opinit.opchild.v1.QueryNextL1SequenceRequest
	10, // 13: opinit.opchild.v1.Query.NextL2Sequence:input_type -> opinit.opchild.v1.QueryNextL2SequenceRequest
	12, // 14: opinit.opchild.v1.Query.BaseDenom:input_type -> opinit.opchild.v1.QueryBaseDenomRequest
	14, // 15: opinit.opchild.v1.Query.ForceWithdrawalProofs:input_type -> opinit.opchild.v1.QueryForceWithdrawalProofsRequest
	1,  // 16: opinit.opchild.v1.Query.Validators:output_type -> opinit.opchild.v1.QueryValidatorsResponse
	3,  // 17: opinit.opchild.v1.Query.Validator:output_type -> opinit.opchild.v1.QueryValidatorResponse
	5,  // 18: opinit.opchild.v1.Query.BridgeInfo:output_type -> opinit.opchild.v1.QueryBridgeInfoResponse
	7,  // 19: opinit.opchild.v1.Query.Params:output_type -> opinit.opchild.v1.QueryParamsResponse
	9,  // 20: opinit.opchild.v1.Query.NextL1Sequence:output_type -> opinit.opchild.v1.QueryNextL1SequenceResponse
	11, // 21: opinit.opchild.v1.Query.NextL2Sequence:output_type -> opinit.opchild.v1.QueryNextL2SequenceResponse
	13, // 22: opinit.opchild.v1.Query.BaseDenom:output_type -> opinit.opchild.v1.QueryBaseDenomResponse
	15, // 23: opinit.opchild.v1.Query.ForceWithdrawalProofs:output_type -> opinit.opchild.v1.QueryForceWithdrawalProofsResponse
...
func file_opinit_opchild_v1_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_opinit_opchild_v1_query_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryForceWithdrawalProofsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_opinit_opchild_v1_query_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*QueryForceWithdrawalProofsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
