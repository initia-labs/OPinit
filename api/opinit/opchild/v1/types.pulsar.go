...
var _ protoreflect.List = (*_PendingDeposits_1_list)(nil)

type _PendingDeposits_1_list struct {
	list *[]*v1beta1.Coin
}

func (x *_PendingDeposits_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_PendingDeposits_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfMessage((*x.list)[i].ProtoReflect())
}

func (x *_PendingDeposits_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	(*x.list)[i] = concreteValue
}

func (x *_PendingDeposits_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Message()
	concreteValue := valueUnwrapped.Interface().(*v1beta1.Coin)
	*x.list = append(*x.list, concreteValue)
}

func (x *_PendingDeposits_1_list) AppendMutable() protoreflect.Value {
	v := new(v1beta1.Coin)
	*x.list = append(*x.list, v)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_PendingDeposits_1_list) Truncate(n int) {
	for i := n; i < len(*x.list); i++ {
		(*x.list)[i] = nil
	}
	*x.list = (*x.list)[:n]
...
func (x *_PendingDeposits_1_list) NewElement() protoreflect.Value {
	v := new(v1beta1.Coin)
	return protoreflect.ValueOfMessage(v.ProtoReflect())
}

func (x *_PendingDeposits_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_PendingDeposits          protoreflect.MessageDescriptor
	fd_PendingDeposits_deposits protoreflect.FieldDescriptor
)

func init() {
	file_opinit_opchild_v1_types_proto_init()
	md_PendingDeposits = File_opinit_opchild_v1_types_proto.Messages().ByName("PendingDeposits")
	fd_PendingDeposits_deposits = md_PendingDeposits.Fields().ByName("deposits")
}
...
func (x *fastReflection_PendingDeposits) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Deposits) != 0 {
		value := protoreflect.ValueOfList(&_PendingDeposits_1_list{list: &x.Deposits})
		if !f(fd_PendingDeposits_deposits, value) {
			return
		}
	}
}
...
func (x *fastReflection_PendingDeposits) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "opinit.opchild.v1.PendingDeposits.deposits":
...
func (x *fastReflection_PendingDeposits) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "opinit.opchild.v1.PendingDeposits.deposits":
		if len(x.Deposits) == 0 {
			return protoreflect.ValueOfList(&_PendingDeposits_1_list{})
		}
		listValue := &_PendingDeposits_1_list{list: &x.Deposits}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.PendingDeposits"))
...
func (x *fastReflection_PendingDeposits) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "opinit.opchild.v1.PendingDeposits.deposits":
		lv := value.List()
		clv := lv.(*_PendingDeposits_1_list)
		x.Deposits = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.PendingDeposits"))
...
func (x *fastReflection_PendingDeposits) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "opinit.opchild.v1.PendingDeposits.deposits":
		if x.Deposits == nil {
			x.Deposits = []*v1beta1.Coin{}
		}
		value := &_PendingDeposits_1_list{list: &x.Deposits}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.PendingDeposits"))
...
func (x *fastReflection_PendingDeposits) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "opinit.opchild.v1.PendingDeposits.deposits":
		list := []*v1beta1.Coin{}
		return protoreflect.ValueOfList(&_PendingDeposits_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.PendingDeposits"))
		}
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				...
				x.Deposits = append(x.Deposits, &v1beta1.Coin{})
...
type PendingDeposits struct {
	...
	Deposits []*v1beta1.Coin `protobuf:"bytes,1,rep,name=deposits,proto3" json:"deposits,omitempty"`
}
...
func (x *PendingDeposits) GetDeposits() []*v1beta1.Coin {
	if x != nil {
		return x.Deposits
	}
	return nil
...
var file_opinit_opchild_v1_types_proto_rawDesc = []byte{
	...
	0x6e, 0x66, 0x69, 0x67, 0x22, 0x7f, 0x0a, 0x0f, 0x50, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x44,
	0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x73, 0x12, 0x6c, 0x0a, 0x08, 0x64, 0x65, 0x70, 0x6f, 0x73,
	...
	0x2e, 0x43, 0x6f, 0x69, 0x6e, 0x73, 0xa8, 0xe7, 0xb0, 0x2a, 0x01, 0x52, 0x08, 0x64, 0x65, 0x70,
	0x6f, 0x73, 0x69, 0x74, 0x73, 0x42, 0xd0, 0x01, 0xc8, 0xe1, 0x1e, 0x00, 0xa8, 0xe2, 0x1e, 0x01,
...
var file_opinit_opchild_v1_types_proto_goTypes = []interface{}{
	...
	(*abci.ValidatorUpdate)(nil), // 7: tendermint.abci.ValidatorUpdate
	(*v1.BridgeConfig)(nil),      // 8: opinit.ophost.v1.BridgeConfig
	(*v1beta1.Coin)(nil),         // 9: cosmos.base.v1beta1.Coin
}
var file_opinit_opchild_v1_types_proto_depIdxs = []int32{
	5, // 0: opinit.opchild.v1.Params.min_gas_prices:type_name -> cosmos.base.v1beta1.DecCoin
	6, // 1: opinit.opchild.v1.Validator.consensus_pubkey:type_name -> google.protobuf.Any
	7, // 2: opinit.opchild.v1.ValidatorUpdates.updates:type_name -> tendermint.abci.ValidatorUpdate
	8, // 3: opinit.opchild.v1.BridgeInfo.bridge_config:type_name -> opinit.ophost.v1.BridgeConfig
	9, // 4: opinit.opchild.v1.PendingDeposits.deposits:type_name -> cosmos.base.v1beta1.Coin
