...
var (
	...
	fd_BridgeInfo_l1_gas_price  protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_BridgeInfo_l1_gas_price = md_BridgeInfo.Fields().ByName("l1_gas_price")
}
...
func (x *fastReflection_BridgeInfo) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.L1GasPrice != nil {
		value := protoreflect.ValueOfMessage(x.L1GasPrice.ProtoReflect())
		if !f(fd_BridgeInfo_l1_gas_price, value) {
			return
		}
	}
}
...
func (x *fastReflection_BridgeInfo) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "opinit.opchild.v1.BridgeInfo.l1_gas_price":
		return x.L1GasPrice != nil
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_BridgeInfo) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "opinit.opchild.v1.BridgeInfo.l1_gas_price":
		x.L1GasPrice = value.Message().Interface().(*v1beta1.DecCoin)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: opinit.opchild.v1.BridgeInfo"))
		}
...
func (x *fastReflection_BridgeInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "opinit.opchild.v1.BridgeInfo.l1_gas_price":
		if x.L1GasPrice == nil {
			x.L1GasPrice = new(v1beta1.DecCoin)
		}
		return protoreflect.ValueOfMessage(x.L1GasPrice.ProtoReflect())
	case "opinit.opchild.v1.BridgeInfo.bridge_id":
...
func (x *fastReflection_BridgeInfo) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.L1GasPrice != nil {
			encoded, err := options.Marshal(x.L1GasPrice)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 6:
				if wireType != 2 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field L1GasPrice", wireType)
				}
				var msglen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if x.L1GasPrice == nil {
					x.L1GasPrice = &v1beta1.DecCoin{}
				}
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.L1GasPrice); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
type BridgeInfo struct {
	...
	L1GasPrice *v1beta1.DecCoin `protobuf:"bytes,6,opt,name=l1_gas_price,json=l1GasPrice,proto3" json:"l1_gas_price,omitempty"`
}
...
func (x *BridgeInfo) GetL1GasPrice() *v1beta1.DecCoin {
	if x != nil {
		return x.L1GasPrice
	}
	return nil
...
var file_opinit_opchild_v1_types_proto_rawDesc = []byte{
	...
	0x3a, 0x04, 0xe8, 0xa0, 0x1f, 0x00, 0x22, 0xcf, 0x02, 0x0a, 0x0a, 0x42, 0x72, 0x69, 0x64, 0x67,
	...
	,
	...
	0x22, 0x40, 0x0a, 0x09, 0x44, 0x65, 0x6e, 0x6f, 0x6d, 0x50, 0x61, 0x69, 0x72, 0x12, 0x14, 0x0a,
	0x05, 0x64, 0x65, 0x6e, 0x6f, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x64, 0x65,
	0x6e, 0x6f, 0x6d, 0x12, 0x1d, 0x0a, 0x0a, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x64, 0x65, 0x6e, 0x6f,
	0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x62, 0x61, 0x73, 0x65, 0x44, 0x65, 0x6e,
	0x6f, 0x6d, 0x2a, 0xa9, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52,
...
var file_opinit_opchild_v1_types_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_opinit_opchild_v1_types_proto_goTypes = []interface{}{
	...
	(*abci.ValidatorUpdate)(nil), // 9: tendermint.abci.ValidatorUpdate
	(*v1.BridgeConfig)(nil),      // 10: opinit.ophost.v1.BridgeConfig
	(*v1beta1.Coin)(nil),         // 11: cosmos.base.v1beta1.Coin
}
var file_opinit_opchild_v1_types_proto_depIdxs = []int32{
	7,  // 0: opinit.opchild.v1.Params.min_gas_prices:type_name -> cosmos.base.v1beta1.DecCoin
	8,  // 1: opinit.opchild.v1.Validator.consensus_pubkey:type_name -> google.protobuf.Any
	9,  // 2: opinit.opchild.v1.ValidatorUpdates.updates:type_name -> tendermint.abci.ValidatorUpdate
	10, // 3: opinit.opchild.v1.BridgeInfo.bridge_config:type_name -> opinit.ophost.v1.BridgeConfig
	7,  // 4: opinit.opchild.v1.BridgeInfo.l1_gas_price:type_name -> cosmos.base.v1beta1.DecCoin
	11, // 5: opinit.opchild.v1.CoinsWrapper.coins:type_name -> cosmos.base.v1beta1.Coin
